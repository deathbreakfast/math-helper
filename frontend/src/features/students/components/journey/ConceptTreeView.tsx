...
export const ConceptTreeView: React.FC<ConceptTreeViewProps> = ({
  ...
  const debugConcepts = useMemo(() => {
    return concepts.filter(c => 
      c.conceptId === 'c_add_0s' || c.conceptId === 'c_add_1s' || c.conceptId === 'c_add_2s' || c.conceptId === 'c_add_3s' || c.conceptId === 'c_add_4s' || c.conceptId === 'c_add_5s' || c.conceptId === 'c_add_6s' || c.conceptId === 'c_add_7s' || c.conceptId === 'c_add_8s' || c.conceptId === 'c_add_9s' || c.conceptId === 'c_add_10s' || c.conceptId === 'c_sub_0s' || c.conceptId === 'c_sub_1s' || c.conceptId === 'c_sub_2s' || c.conceptId === 'c_sub_3s' || c.conceptId === 'c_sub_4s' || c.conceptId === 'c_sub_5s' || c.conceptId === 'c_sub_6s' || c.conceptId === 'c_sub_7s' || c.conceptId === 'c_sub_8s' || c.conceptId === 'c_sub_9s' || c.conceptId === 'c_sub_10s'
    )
  }, [concepts])
